...
{
	T Buffer;
	ReadProcessMemory(processHandle, (LPCVOID)BaseAddress, &Buffer, sizeof(Buffer), nullptr);
...
entrypoint:
	...
	{
		//		CString str1;
		//str1.Format(_T("%d"), libtersafeheader);
		//string s = to_string(libtersafeheader);
		//MessageBoxA(0, "fuck libtersafeheader ", s.c_str(), 0);


		//SAFE 2.0 O

		//memory.WriteBytes(libtersafeheader + 0x342C0, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);
		////memory.WriteBytes(libtersafeheader + 0x371FA, new BYTE[]{0x32 }, true);
		//memory.WriteBytes(libtersafeheader + 0x37214, new BYTE[]{0x32,0x00 }, true);
		//memory.WriteBytes(libtersafeheader + 0x3722A, new BYTE[]{0x32,0x00,0x32,0x00,0x32,0x00 }, true);
	...
	//
	//	
	//	memory.WriteBytes(libtersafeheader + 0xEC4BC, new BYTE[]{ 0x00, 0x20, 0x70, 0x47 }, true);
	//	memory.WriteBytes(libtersafeheader + 0x44ED8, new BYTE[]{ 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
	...
	//	//
		...
		//memory.WriteBytes(libtersafeheader + 0x39665D, new BYTE[]{ 0x10,0x0F }, true);
		//memory.WriteBytes(libtersafeheader + 0x396791, new BYTE[]{ 0xE5,0x0E }, true);
		//----------------------------------------------------------------------------------------------------------------
	
		//memory.WriteBytes(libtersafeheader + 0x342C0, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);
		//memory.WriteBytes(libtersafeheader + 0x371EB, new BYTE[]{ 0x00,0x59,0x00,0x59,0x00,0x59,0x00,0x59,0x00,0x59,0x00,0x59 }, true);
		//memory.WriteBytes(libtersafeheader + 0x371FA, new BYTE[]{ 0x59 }, true);
		//memory.WriteBytes(libtersafeheader + 0x37204, new BYTE[]{ 0x59,0x00,0x59,0x00 }, true);
		//memory.WriteBytes(libtersafeheader + 0x3720A, new BYTE[]{ 0x59,0x00,0x59,0x00,0x59,0x00,0x59,0x00,0x59 }, true);
		//memory.WriteBytes(libtersafeheader + 0x37214, new BYTE[]{ 0x59,0x00,0x59,0x00,0x59 }, true);
		//memory.WriteBytes(libtersafeheader + 0x37224, new BYTE[]{ 0x59,0x00,0x59,0x00,0x59,0x00,0x59,0x00,0x59,0x00,0x00,0x00 }, true);
		//memory.WriteBytes(libtersafeheader + 0x37244, new BYTE[]{ 0x59,0x00 }, true);
		//memory.WriteBytes(libtersafeheader + 0x5EBAE, new BYTE[]{ 0x70,0x47,0x70,0x47 }, true);
		//memory.WriteBytes(libtersafeheader + 0x5EBCC, new BYTE[]{ 0x70,0x47,0x70,0x47 }, true);
		//memory.WriteBytes(libtersafeheader + 0x5EDBE, new BYTE[]{ 0xA8,0x00 }, true);
		//memory.WriteBytes(libtersafeheader + 0x5EDC1, new BYTE[]{ 0x00 }, true);
		//memory.WriteBytes(libtersafeheader + 0x5FB0A, new BYTE[]{ 0xA8,0x00,0x00,0x00 }, true);
		//memory.WriteBytes(libtersafeheader + 0x696C0, new BYTE[]{ 0x70,0x47 }, true);
		//memory.WriteBytes(libtersafeheader + 0x85088, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
		//memory.WriteBytes(libtersafeheader + 0xA0018, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA0024, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA02E8, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA034C, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA039C, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA03B4, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA03C4, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA03D8, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA03EC, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA051C, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA0524, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA0664, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA0754, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA0904, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA09BC, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA0B58, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA0BB8, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA0C40, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA0CB0, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA0E60, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA0EAC, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA0FE8, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA1034, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA1170, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA11BC, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA1350, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA14AC, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA14D4, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA1544, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA158C, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA15D4, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA15DC, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA1660, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA191C, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA1944, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA19B4, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA19FC, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA1A44, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA1A4C, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA1AD0, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA1D7C, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA1DA4, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA1E14, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA1E5C, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xA1EA4, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xDF204, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);
		//memory.WriteBytes(libtersafeheader + 0xDF238, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);
		//memory.WriteBytes(libtersafeheader + 0xDF26C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);
		//memory.WriteBytes(libtersafeheader + 0xDF4FD, new BYTE[]{ 0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);
		//memory.WriteBytes(libtersafeheader + 0xE041D, new BYTE[]{ 0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);
		//memory.WriteBytes(libtersafeheader + 0xE414D, new BYTE[]{ 0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);
		//memory.WriteBytes(libtersafeheader + 0xE431D, new BYTE[]{ 0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);
		//memory.WriteBytes(libtersafeheader + 0xE6BD5, new BYTE[]{ 0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);
		//memory.WriteBytes(libtersafeheader + 0xE836D, new BYTE[]{ 0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);//here you can add it
		//memory.WriteBytes(libtersafeheader + 0xEE970, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
		//memory.WriteBytes(libtersafeheader + 0xEEA14, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
		//memory.WriteBytes(libtersafeheader + 0xEEA24, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
		//memory.WriteBytes(libtersafeheader + 0xEEAC8, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
		//memory.WriteBytes(libtersafeheader + 0xEEB54, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
		//memory.WriteBytes(libtersafeheader + 0xEEC44, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
		//memory.WriteBytes(libtersafeheader + 0xEECAC, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
		//memory.WriteBytes(libtersafeheader + 0xEECD0, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
		//memory.WriteBytes(libtersafeheader + 0xEEE80, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
		//memory.WriteBytes(libtersafeheader + 0xF2990, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libtersafeheader + 0xF442C, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
		//memory.WriteBytes(libtersafeheader + 0xF4A7C, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
		//memory.WriteBytes(libtersafeheader + 0xF4AB0, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
		//memory.WriteBytes(libtersafeheader + 0xF65D4, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);
		//memory.WriteBytes(libtersafeheader + 0xF6DDC, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xF6DF8, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xF6E04, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xF6E10, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xF6E24, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xF6E44, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xF6E58, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xF6E6C, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xF6E80, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xF6E94, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xF6EA8, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xF6EBC, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xF6ED0, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xF6EE4, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xF6EF8, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xF6F0C, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xF6F20, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xF6F34, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xF6F48, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xF6F5C, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xF6F70, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xF6F84, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xF6F98, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xF6FAC, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xF6FC0, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xF6FD4, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xF6FE8, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0xF7114, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0x17756D, new BYTE[]{ 0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);
		//memory.WriteBytes(libtersafeheader + 0x177689, new BYTE[]{ 0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);
		//memory.WriteBytes(libtersafeheader + 0x17796C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libtersafeheader + 0x17CA9D, new BYTE[]{ 0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);
		//memory.WriteBytes(libtersafeheader + 0x17DB14, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);
		//memory.WriteBytes(libtersafeheader + 0x29BD78, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0x29BDCC, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0x2A54F4, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0x2A566C, new BYTE[]{ 0x00,0xA0 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2A5670, new BYTE[]{ 0x1E }, true);
		//memory.WriteBytes(libtersafeheader + 0x2A5672, new BYTE[]{ 0x2F,0xE1,0x00 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2A5676, new BYTE[]{ 0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2A5738, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0x2A5794, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0x2A6670, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0x2A6780, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0x2A70CC, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0x2A71B4, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);
		//memory.WriteBytes(libtersafeheader + 0x2A75E0, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0x2A8008, new BYTE[]{ 0x00,0x20,0x70,0x47  }, true);
		//memory.WriteBytes(libtersafeheader + 0x2A8154, new BYTE[]{ 0x00 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2A8156, new BYTE[]{ 0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2A94EC, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2AA8D0, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2AA9C8, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2AABEC, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2AAC40, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2AAC9C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2AACC1, new BYTE[]{ 0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2ABA50, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);//
		//memory.WriteBytes(libtersafeheader + 0x2ABB04, new BYTE[]{ 0x00 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2ABB08, new BYTE[]{ 0x1E }, true);
		//memory.WriteBytes(libtersafeheader + 0x2ABB0A, new BYTE[]{ 0x2F,0xE1,0x00 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2ABB10, new BYTE[]{ 0x1E }, true);
		//memory.WriteBytes(libtersafeheader + 0x2ABB12, new BYTE[]{ 0x2F,0xE1,0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2AE484, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2AE8F4, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2AF1AC, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2AF384, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);
		//memory.WriteBytes(libtersafeheader + 0x2AF50C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);
		//memory.WriteBytes(libtersafeheader + 0x2B7AA0, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2B80A8, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2B9AB0, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2B9C94, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2BDD9C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2C137C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2C3F9C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);
		//memory.WriteBytes(libtersafeheader + 0x2C4CC0, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2C4F1C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2C8144, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2C8268, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2C8278, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2CBA88, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);
		//memory.WriteBytes(libtersafeheader + 0x2CEC20, new BYTE[]{ 0x00 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2CEC22, new BYTE[]{ 0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2D09D4, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2D0FA4, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2D1B4C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2D6840, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2D7200, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libtersafeheader + 0x2D7BA8, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libtersafeheader + 0x39665D, new BYTE[]{ 0x80,0x9D,0x06 }, true);
		//memory.WriteBytes(libtersafeheader + 0x396791, new BYTE[]{ 0x55,0x9D,0x06 }, true);


	//	Sleep(4000);
	//
		//memory.WriteBytes(libue4header + 0xF59D36, new BYTE[]{ 0x35 }, true);
		//memory.WriteBytes(libue4header + 0xF59D38, new BYTE[]{ 0x34 }, true);
		//memory.WriteBytes(libue4header + 0xF59D3C, new BYTE[]{ 0x31 }, true);
		//memory.WriteBytes(libue4header + 0xF59D3E, new BYTE[]{ 0x34 }, true);
	//	memory.WriteBytes(libue4header + 0xF616BC, new BYTE[]{ 0x01,0x40,0xA0,0xE1,0x04,0x00,0xA0,0xE1 }, true);
	//	memory.WriteBytes(libue4header + 0x11C11EC, new BYTE[]{ 0x00,0x40,0xA0,0xE1 }, true);
	//	memory.WriteBytes(libue4header + 0x11C11F1, new BYTE[]{ 0x01,0x94,0xE5 }, true);
	//	memory.WriteBytes(libue4header + 0x1236664, new BYTE[]{ 0x00,0x40,0xA0,0xE1,0x02,0xA0,0xA0,0xE1 }, true);//	R
	//	memory.WriteBytes(libue4header + 0x12705A4, new BYTE[]{ 0x00,0x90,0xA0,0xE1,0x38,0xF0,0x02,0xEB }, true);//
	//	memory.WriteBytes(libue4header + 0x12A4308, new BYTE[]{ 0x02,0x80,0xA0,0xE1 }, true);//
	//	memory.WriteBytes(libue4header + 0x12A430D, new BYTE[]{ 0x40,0xA0,0xE1 }, true);//
	//	memory.WriteBytes(libue4header + 0x12ED021, new BYTE[]{ 0x00,0xA0,0xE1,0x31,0xFF,0x2F,0xE1 }, true);//
	//	//memory.WriteBytes(libue4header + 0x12F2BE4, new BYTE[]{ 0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);
	//	//memory.WriteBytes(libue4header + 0x12F2BE9, new BYTE[]{ 0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);//
	//	//memory.WriteBytes(libue4header + 0x12F3E5C, new BYTE[]{ 0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);
	//	//memory.WriteBytes(libue4header + 0x12F3E61, new BYTE[]{ 0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);//F
	//	memory.WriteBytes(libue4header + 0x143D254, new BYTE[]{ 0x00,0x40,0xA0,0xE1,0x01,0x50,0xA0,0xE3,0x50,0x01,0x94 }, true);//
	//	memory.WriteBytes(libue4header + 0x143D260, new BYTE[]{ 0x01,0x00,0x80,0xE2 }, true);//
	//	memory.WriteBytes(libue4header + 0x143D40C, new BYTE[]{ 0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);//
	//	memory.WriteBytes(libue4header + 0x143F438, new BYTE[]{ 0x00,0x40,0xA0,0xE1,0xAF,0xAB,0xD8,0xEB }, true);//
	//	memory.WriteBytes(libue4header + 0x1793A08, new BYTE[]{ 0x00,0x50,0xA0,0xE1,0xEB,0xD5,0xFF,0xEB }, true);//
	//	memory.WriteBytes(libue4header + 0x17A5FC8, new BYTE[]{ 0x00,0x50,0xA0,0xE1,0x0D,0x40,0xA0,0xE1 }, true);//
	//	memory.WriteBytes(libue4header + 0x1E91038, new BYTE[]{ 0x00,0x40,0xA0,0xE1,0x62,0x70,0x0E,0xEB }, true);//
	///*	memory.WriteBytes(libue4header + 0x1ED0C48, new BYTE[]{ 0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);
	//	memory.WriteBytes(libue4header + 0x1ED0C4C, new BYTE[]{ 0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);*/
	//	//memory.WriteBytes(libue4header + 0x1ED1E6C, new BYTE[]{ 0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);//relaod
	//	//memory.WriteBytes(libue4header + 0x1EEA40C, new BYTE[]{ 0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);
	//	memory.WriteBytes(libue4header + 0x1EEA410, new BYTE[]{ 0x08,0x00,0xA0,0xE1 }, true);//
	//	memory.WriteBytes(libue4header + 0x21772DC, new BYTE[]{ 0x01,0x50,0xA0,0xE1 }, true);
	//	memory.WriteBytes(libue4header + 0x21772E1, new BYTE[]{ 0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);
	//	memory.WriteBytes(libue4header + 0x259FB48, new BYTE[]{ 0x00,0x00,0x9F,0xE7 }, true);//
	//	memory.WriteBytes(libue4header + 0x259FB4D, new BYTE[]{ 0x00,0xD0,0xE5 }, true);//
	//	memory.WriteBytes(libue4header + 0x261D144, new BYTE[]{ 0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);//T
	//	memory.WriteBytes(libue4header + 0x4308218, new BYTE[]{ 0x00,0x50,0xA0,0xE1,0x01,0x90,0xA0,0xE1 }, true);
	//	memory.WriteBytes(libue4header + 0x44F6B90, new BYTE[]{ 0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);//T
	//	memory.WriteBytes(libue4header + 0x452D3DC, new BYTE[]{ 0x01,0x80,0xA0,0xE1,0xB8,0x10,0x4B,0xE2 }, true);
	//	memory.WriteBytes(libue4header + 0x452D3F0, new BYTE[]{ 0x00,0x00,0x90 }, true);
	//	memory.WriteBytes(libue4header + 0x452D3F4, new BYTE[]{ 0x48,0x00,0x0B,0xE5 }, true);
		//----------------------------------------------------------------------------------------------------------------
//memory.WriteBytes(libtersafeheader + 0x342C0, new BYTE[]{ 0x00,0x00,0xB0,0xE3,0x1E,0xFF,0x2F }, true);
//memory.WriteBytes(libtersafeheader + 0x37214, new BYTE[]{ 0x32,0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x3722A, new BYTE[]{ 0x32,0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x37EC4, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
//memory.WriteBytes(libtersafeheader + 0x846A0, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
//memory.WriteBytes(libtersafeheader + 0x85088, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
//memory.WriteBytes(libtersafeheader + 0xEC7F8, new BYTE[]{ 0x00,0x00,0xB0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
//memory.WriteBytes(libtersafeheader + 0x289070, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
//memory.WriteBytes(libtersafeheader + 0x2890A8, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
//memory.WriteBytes(libtersafeheader + 0x29A138, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
//memory.WriteBytes(libtersafeheader + 0x29BD78, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
...
//
///// <summary>
//memory.WriteBytes(libtersafeheader + 0x44F1D, new BYTE[]{ 0x2F,0xE1,0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x44F46, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
//memory.WriteBytes(libtersafeheader + 0x5EE22, new BYTE[]{ 0x2F,0xE1,0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x6C99A, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
//memory.WriteBytes(libtersafeheader + 0xEC7F9, new BYTE[]{0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F }, true);
////memory.WriteBytes(libtersafeheader + 0x39665D, 0x50, 0x05, 0x07 }, true);
////memory.WriteBytes(libtersafeheader + 0x396791, 0x25, 0x05, 0x07 }, true);
///// </summary>
//memory.WriteBytes(libtersafeheader + 0x39665D, new BYTE[]{ 0x80,0x9D,0x06 }, true);
//memory.WriteBytes(libtersafeheader + 0x396791, new BYTE[]{ 0x55,0x9D,0x06 }, true);
//
//memory.WriteBytes(libtersafeheader +0x5EB64, new BYTE[]{ 0x78,0x47,0xC0,0x46,0x04,0xF0,0x1F,0xE5,0xF0,0xA1,0x73,0x44 }, true);
//memory.WriteBytes(libtersafeheader +0xEC7F8, new BYTE[]{04 F0 1F E5 CC A1 73 44 }, true);
//memory.WriteBytes(libtersafeheader +0x25BE68, new BYTE[]{ 0x78,0x47,0xC0,0x46,0x04,0xF0,0x1F,0xE5,0x24,0xD7,0x73,0x44,0xC0,0x46 }, true);
//PatchMemory("0x39665D", "00 22 08", libtersafeLong);
//PatchMemory("0x396791", "D5 21 08", libtersafeLong);
////memory.WriteBytes(libtersafeheader + 0x39665D, new BYTE[]{ 0x90,0xD5,0x05 }, true);
////memory.WriteBytes(libtersafeheader + 0x396791, new BYTE[]{ 0x65,0xD5,0x05 }, true);
//------------------------------------------------------------------------------------------
//memory.WriteBytes(libtersafeheader + 0x342C0, new BYTE[]{ 0x00,0x00,0xB0,0xE3,0x1E,0xFF,0x2F }, true);
////memory.WriteBytes(libtersafeheader + 0x371FA, new BYTE[]{ 0x09 }, true);
////memory.WriteBytes(libtersafeheader + 0x371FC, new BYTE[]{ 0xF8,0x6C }, true);
////memory.WriteBytes(libtersafeheader + 0x37212, new BYTE[]{ 0x09 }, true);
////memory.WriteBytes(libtersafeheader + 0x37214, new BYTE[]{ 0x32,0x00 }, true);
////memory.WriteBytes(libtersafeheader + 0x3722A, new BYTE[]{ 0x32,0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x37EC4, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
//memory.WriteBytes(libtersafeheader + 0x846A0, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
//memory.WriteBytes(libtersafeheader + 0x85088, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
//memory.WriteBytes(libtersafeheader + 0xEC7F8, new BYTE[]{ 0x00,0x00,0xB0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
//memory.WriteBytes(libtersafeheader + 0xEC7F9, new BYTE[]{ 0x00,0xB0,0xE3,0x1E,0xFF,0x2F }, true);
//memory.WriteBytes(libtersafeheader + 0x289070, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
//memory.WriteBytes(libtersafeheader + 0x2890A8, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
//memory.WriteBytes(libtersafeheader + 0x29A138, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
//memory.WriteBytes(libtersafeheader + 0x29BD78, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
//memory.WriteBytes(libtersafeheader + 0x29BDCC, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
//memory.WriteBytes(libtersafeheader + 0x39665D, new BYTE[]{ 0x30,0x88,0x05 }, true);
//memory.WriteBytes(libtersafeheader + 0x396791, new BYTE[]{ 0x05,0x88,0x05 }, true);
//memory.WriteBytes(libtersafeheader + 0x44ED8, new BYTE[]{ 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47}, true);

//memory.WriteBytes(libtersafeheader + 0x3B6D04, new BYTE[]{ 0x01 }, true);
//-------------------------------------------------------------------------------------------------------------------
//memory.WriteBytes(libtersafeheader + 0x342C0, new BYTE[]{ 0x00,0x00,0xB0,0xE3,0x1E,0xFF,0x2F }, true);
//memory.WriteBytes(libtersafeheader + 0x371FA, new BYTE[]{ 0x59 }, true);
//memory.WriteBytes(libtersafeheader + 0x37214, new BYTE[]{ 0x32,0x00 }, true);
...
//memory.WriteBytes(libtersafeheader + 0x29BD78, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
//memory.WriteBytes(libtersafeheader + 0x29BDCC, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
//memory.WriteBytes(libtersafeheader + 0x39665D, new BYTE[]{ 0x60,0x39 }, true);
//memory.WriteBytes(libtersafeheader + 0x396791, new BYTE[]{ 0x35,0x39}, true);
//memory.WriteBytes(libtersafeheader + 0x3B6D04, new BYTE[]{ 0x00}, true);



//memory.WriteBytes(libtersafeheader + 0x33AC8, new BYTE[]{ 0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);
//memory.WriteBytes(libtersafeheader + 0x337B0, new BYTE[]{ 0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);
//memory.WriteBytes(libtersafeheader + 0x371EA, new BYTE[]{ 0x59, 0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x371EC, new BYTE[]{ 0x59, 0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x371EE, new BYTE[]{ 0x59, 0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x371F2, new BYTE[]{ 0x59, 0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x371F4, new BYTE[]{ 0x59, 0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x371F6, new BYTE[]{ 0x59, 0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x371F8, new BYTE[]{ 0x59, 0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x371FA, new BYTE[]{ 0x59, 0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x371FE, new BYTE[]{ 0x59, 0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x37200, new BYTE[]{ 0x59, 0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x37202, new BYTE[]{ 0x59, 0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x37204, new BYTE[]{ 0x59, 0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x37206, new BYTE[]{ 0x59, 0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x3720A, new BYTE[]{ 0x59, 0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x3720C, new BYTE[]{ 0x59, 0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x3720E, new BYTE[]{ 0x59, 0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x37210, new BYTE[]{ 0x59, 0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x37212, new BYTE[]{ 0x59, 0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x37214, new BYTE[]{ 0x59, 0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x37216, new BYTE[]{ 0x59, 0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x37218, new BYTE[]{ 0x59, 0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x3721A, new BYTE[]{ 0x59, 0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x37220, new BYTE[]{ 0x59, 0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x37224, new BYTE[]{ 0x59, 0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x37226, new BYTE[]{ 0x59, 0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x37228, new BYTE[]{ 0x59, 0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x3722A, new BYTE[]{ 0x59, 0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x3722C, new BYTE[]{ 0x59, 0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x3722E, new BYTE[]{ 0x00, 0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x37238, new BYTE[]{ 0x59, 0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x3723C, new BYTE[]{ 0x59, 0x00 }, true);
//
//memory.WriteBytes(libtersafeheader + 0x37240, new BYTE[]{ 0x59, 0x00 }, true);
//
//memory.WriteBytes(libtersafeheader + 0x37244, new BYTE[]{ 0x59, 0x00 }, true);
//
//memory.WriteBytes(libtersafeheader + 0x37EC4, new BYTE[]{ 0x00, 0x20, 0x70, 0x47 }, true);;
//memory.WriteBytes(libtersafeheader + 0x5EBAE, new BYTE[]{ 0x70, 0x47 }, true);
//memory.WriteBytes(libtersafeheader + 0x5EBCC, new BYTE[]{ 0x70, 0x47 }, true);
//memory.WriteBytes(libtersafeheader + 0x5EDBE, new BYTE[]{ 0xA8, 0x00, 0x00, 0x00, 0x70, 0x47 }, true);;
//memory.WriteBytes(libtersafeheader + 0x5FB0A, new BYTE[]{ 0x70, 0x47 }, true);
//memory.WriteBytes(libtersafeheader + 0x25EC48, new BYTE[]{ 0x70, 0x47 }, true);
//memory.WriteBytes(libtersafeheader + 0x25EC70, new BYTE[]{ 0x70, 0x47 }, true);
//memory.WriteBytes(libtersafeheader + 0x25EC5C, new BYTE[]{ 0x70, 0x47 }, true);
//memory.WriteBytes(libtersafeheader + 0x27B332, new BYTE[]{ 0xA8, 0x00, 0x00, 0x00, 0x70, 0x47 }, true);;
//memory.WriteBytes(libtersafeheader + 0x27B338, new BYTE[]{ 0xA8, 0x00, 0x00, 0x00, 0x70, 0x47 }, true);;
//memory.WriteBytes(libtersafeheader + 0x27B33E, new BYTE[]{ 0xA8, 0x00, 0x00, 0x00, 0x70, 0x47 }, true);;
//memory.WriteBytes(libtersafeheader + 0xE3F4C, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0xE041C, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0xDF4FC, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0xE041D, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0xE414D, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x10ED5C, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x16209C, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x1021BC, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x17A109, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x17D5FC, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x17D5FD, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x17DB14, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x2A54F4, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x2A566C, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x2A5674, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x27ADF0, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x27AE28, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x27A690, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x2A8008, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x2A8154, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x2AABEC, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x2AAC40, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x2ABA90, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x2AE484, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x2AE8F4, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x2B9AB0, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x2D0FA4, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x2D09D4, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x2A6780, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x2A92D8, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x2AF100, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x2C8144, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x2C8268, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x2CEC20, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x2A71B4, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x2ACF40, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x2BF544, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x2D6598, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x2D66B0, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x2D6840, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x2DA420, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x2D2838, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x2AA9C8, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x2AA8D0, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x2B80A8, new BYTE[]{ 0x00, 0x00, 0xB0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1 }, true);;
//memory.WriteBytes(libtersafeheader + 0x39665D, new BYTE[]{ 0x60,0x39 }, true);
//memory.WriteBytes(libtersafeheader + 0x396791, new BYTE[]{ 0x35,0x39 }, true);
//memory.WriteBytes(libtersafeheader + 0x3B6D04, new BYTE[]{ 0x00 }, true);
suspend(pid);
...
//memory.WriteBytes(libtersafeheader + 0x342C0, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);
//memory.WriteBytes(libtersafeheader + 0x371EB, new BYTE[]{ 0x00,0x59,0x00,0x59,0x00,0x59,0x00,0x59,0x00,0x59,0x00,0x59 }, true);
//memory.WriteBytes(libtersafeheader + 0x371F8, new BYTE[]{ 0x59 }, true);
//memory.WriteBytes(libtersafeheader + 0x371FA, new BYTE[]{ 0x59 }, true);
//memory.WriteBytes(libtersafeheader + 0x371FE, new BYTE[]{ 0x59,0x00,0x59,0x00,0x59 }, true);
//memory.WriteBytes(libtersafeheader + 0x37204, new BYTE[]{ 0x59,0x00,0x59,0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x3720A, new BYTE[]{ 0x59,0x00,0x59,0x00,0x59,0x00,0x59,0x00,0x59 }, true);
//memory.WriteBytes(libtersafeheader + 0x37214, new BYTE[]{ 0x59,0x00,0x59,0x00,0x59 }, true);
//memory.WriteBytes(libtersafeheader + 0x3721A, new BYTE[]{ 0x59,0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x37220, new BYTE[]{ 0x59,0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x37224, new BYTE[]{ 0x59,0x00,0x59,0x00,0x59,0x00,0x59,0x00,0x59,0x00,0x59,0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x37238, new BYTE[]{ 0x59 }, true);
//memory.WriteBytes(libtersafeheader + 0x3723C, new BYTE[]{ 0x59,0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x37240, new BYTE[]{ 0x59,0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x37244, new BYTE[]{ 0x59,0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x44F1D, new BYTE[]{ 0x00,0x00,0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x44F46, new BYTE[]{ 0x00,0x00,0x00,0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x5EC5E, new BYTE[]{ 0x00,0x00,0x00,0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x5EDC8, new BYTE[]{ 0x4F,0xF0,0x00,0x00,0x70,0x47 }, true);
//memory.WriteBytes(libtersafeheader + 0x5EE22, new BYTE[]{ 0xA8,0x00,0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x85088, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
//memory.WriteBytes(libtersafeheader + 0xDF204, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);
//memory.WriteBytes(libtersafeheader + 0xDF238, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);
//memory.WriteBytes(libtersafeheader + 0xDF26C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);
...
//memory.WriteBytes(libtersafeheader + 0x2890A8, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
//memory.WriteBytes(libtersafeheader + 0x29A138, new BYTE[]{ 0x00,0x20,0x70,0x47 }, true);
//memory.WriteBytes(libtersafeheader + 0x2AABEC, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
//memory.WriteBytes(libtersafeheader + 0x2AAC40, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
//memory.WriteBytes(libtersafeheader + 0x2AAC9C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
//memory.WriteBytes(libtersafeheader + 0x2AACC1, new BYTE[]{ 0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
//memory.WriteBytes(libtersafeheader + 0x2ABA50, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
...
memory.WriteBytes(libtersafeheader + 0x44f46, new BYTE[]{0x00, 0x00, 0x00, 0x00}, true);
memory.WriteBytes(libtersafeheader + 0x5ee22, new BYTE[]{0xa8, 0x00, 0x00}, true);
memory.WriteBytes(libtersafeheader + 0x6c99a, new BYTE[]{0x00, 0x00, 0x00, 0x00}, true);
memory.WriteBytes(libtersafeheader + 0x846a0, new BYTE[]{0x00, 0x20, 0x70, 0x47}, true);
memory.WriteBytes(libtersafeheader + 0x85088, new BYTE[]{0x00, 0x20, 0x70, 0x47}, true);
memory.WriteBytes(libtersafeheader + 0xec7f9, new BYTE[]{ 0x00, 0xa0, 0xe3, 0x1e, 0xff, 0x2f}, true);
memory.WriteBytes(libtersafeheader + 0x289070,new BYTE[]{0x00, 0x20, 0x70, 0x47}, true);
...
memory.WriteBytes(libtersafeheader + 0x29bd78,new BYTE[]{0x00, 0x20, 0x70, 0x47}, true);
memory.WriteBytes(libtersafeheader + 0x29bdcc,new BYTE[]{0x00, 0x20, 0x70, 0x47}, true);
memory.WriteBytes(libtersafeheader + 0x2c92bc,new BYTE[]{0x59, 0x00}, true);
//memory.WriteBytes(libtersafeheader + 0x95E5C, new BYTE[]{ 0x00,0x00,0xB0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
//memory.WriteBytes(libtersafeheader + 0x39665E, new BYTE[]{ 0xCB,0x05 }, true);
//memory.WriteBytes(libtersafeheader + 0x396792, new BYTE[]{ 0xCB,0x05 }, true);
//memory.WriteBytes(libtersafeheader + 0x399024, new BYTE[]{ 0x2A }, true);
//memory.WriteBytes(libtersafeheader + 0x399028, new BYTE[]{ 0x30 }, true);
//memory.WriteBytes(libtersafeheader + 0x399038, new BYTE[]{ 0x01,0x00,0x00,0x00 }, true);
//memory.WriteBytes(libtersafeheader + 0x3B6D04, new BYTE[]{ 0x00 }, true);
...
//memory.WriteBytes(libtersafeheader + 0x3B6D04, new BYTE[]{ 0x00 }, true);
		...
		//////pardox
		//memory.WriteBytes(libue4header + 0xF3C13C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0xF3F059, new BYTE[]{ 0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);
		//memory.WriteBytes(libue4header + 0xF3F0F0, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0xF47B58, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0xF4952C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0xF4A3CC, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0xF4EE00, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0xF51A00, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0xF6A6F0, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0xF6A9F4, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);//work
		//memory.WriteBytes(libue4header + 0x106C784, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);//tested to here


		//memory.WriteBytes(libue4header + 0x11DA2CC, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x11EF9AC, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x11F20A8, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x11F25E4, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x11F2F24, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x11F33A8, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x11F3854, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x11F3A98, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x11F8960, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x11F93AC, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x11FACCC, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x11FB210, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1201890, new BYTE[]{ 0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1201C90, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x120D830, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1278FA4, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x127907C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x127D400, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x12FBE9C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x12FD784, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x13303B4, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1341BB8, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x14DBA64, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x14DBD3C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x14DE900, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x14DE9F0, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x14DEAC8, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x153363C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x153462C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x153483C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x15349B8, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x15356E8, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1535B90, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1536AFC, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1536ED8, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x15372C8, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x153A2A8, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x153A900, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x153AC64, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x153B2D8, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x153BC34, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x153BDD0, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x153BF48, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x153CD14, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x153D4BC, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x153EED4, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x153F2B4, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x153F558, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x153F7D0, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x153FA20, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x153FBF8, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x15417A4, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1541C80, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1542C0C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x15643A8, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1565BBC, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x158B6B8, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x15BAEAC, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x16308B0, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1630CF4, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1642488, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x164753C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1647D7C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1647F7C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1648B38, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x164BF30, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x165A63C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x166DE80, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x16B530C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x16B7520, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x16BB29C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x16C2630, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x16C89D4, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x16F9B38, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x16F9DFC, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x16FAFE4, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x170E564, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1723750, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1723D51, new BYTE[]{ 0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);
		//memory.WriteBytes(libue4header + 0x1728F04, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1839FF4, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x183A164, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x183A1C0, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1843664, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x184390C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x19DA5F8, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x19F3190, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1A08340, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1A09548, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1A09B70, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1A0B0C0, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1A0B478, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1A0BDD8, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1A1189C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1A12890, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1A12DF0, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1A13410, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1A1365C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1A13D04, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1A14008, new BYTE[]{ 0x00 }, true);
		//memory.WriteBytes(libue4header + 0x1A1400A, new BYTE[]{ 0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1A148D1, new BYTE[]{ 0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);
		//memory.WriteBytes(libue4header + 0x1A15A20, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1A22B60, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1A22CA0, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1A2F1CC, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1A31020, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1A314D8, new BYTE[]{ 0x00 }, true);
		//memory.WriteBytes(libue4header + 0x1A34445, new BYTE[]{ 0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);
		//memory.WriteBytes(libue4header + 0x1A373E8, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1A37AF0, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1A37CF4, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1A3D108, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1A3D24D, new BYTE[]{ 0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);
		//memory.WriteBytes(libue4header + 0x1A3D304, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1A3D401, new BYTE[]{ 0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);
		//memory.WriteBytes(libue4header + 0x1AFC1BC, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1AFC32C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1AFC611, new BYTE[]{ 0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);
		//memory.WriteBytes(libue4header + 0x1AFC73C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1AFC898, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1AFCA38, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1AFCEC0, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1B013D4, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);//
		//memory.WriteBytes(libue4header + 0x1B020D1, new BYTE[]{ 0x00,0xA0,0xE3,0x1E,0xFF,0x2F }, true);
		//memory.WriteBytes(libue4header + 0x1B02848, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1B02D5C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1B03070, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1B03F3C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1C1ED58, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1D99C80, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1DE0F8C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1DF5A50, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1E447A1, new BYTE[]{ 0x00 }, true);
		//memory.WriteBytes(libue4header + 0x1E447A4, new BYTE[]{ 0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1F0A1A8, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1F0A9A8, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1F0B488, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1F0B9AC, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1F0BE98, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1F0C388, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x1F197F0, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x208F7EC, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x20B6858, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x213A57C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x2178D6C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x2179BD4, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x2179D00, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x2179DB0, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x22BC17C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x255A0F4, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);

		////BYPASS
		//memory.WriteBytes(libue4header + 0x25E4AE0, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);//bypass
		//memory.WriteBytes(libue4header + 0x261D0F2, new BYTE[]{ 0xA0 }, true);

		//memory.WriteBytes(libue4header + 0x261D0F4, new BYTE[]{ 0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x261D3EC, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x26373C0, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x2661D44, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x26639C4, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x2663B4C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x2678A20, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x267E2DC, new BYTE[]{ 0x00,0x00,0xA0,0xE1 }, true);



		//memory.WriteBytes(libue4header + 0x26D9244, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x26D9394, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x26D9500, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x26D973C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x26D97AC, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x26D98F4, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x26DB470, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x26EA834, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x26EB250, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x26EB668, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x26EB858, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x26F6388, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x276A1F8, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x277F75C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x27902C8, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x28131B4, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x2813384, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x2895F28, new BYTE[]{ 0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x2898758, new BYTE[]{ 0x00 }, true);
		//memory.WriteBytes(libue4header + 0x289875B, new BYTE[]{ 0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x28CBA04, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x28CBB3C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x28CD13C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x28D504C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x2F4ECA0, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x3741BF0, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x3A8AD1C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x3A8B568, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x3A8B6B8, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x3A8B808, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x3A8B958, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x3A8BBCC, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x3A8BE7C, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x3A8C218, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x3A8CBB4, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x3A8CF20, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x3A8D924, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x3C147C8, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x3C14C88, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x3C14F80, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x3D19C80, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x3D1A228, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x3E463C4, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x3E46AA0, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		////memory.WriteBytes(libue4header + 0x3E825E6, new BYTE[]{ 0x90 }, true);
		//memory.WriteBytes(libue4header + 0x3E902C4, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x3E92930, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x3E93CA4, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
		//memory.WriteBytes(libue4header + 0x44F6B90, new BYTE[]{ 0x46 }, true);
		//memory.WriteBytes(libue4header + 0x452CE40, new BYTE[]{ 0x00,0x00,0xA0,0xE3,0x1E,0xFF,0x2F,0xE1 }, true);
	...
	/*			CString str1;
		...
		MessageBoxA(0, "fuck libtersafeheader ", s.c_str(), 0);*/
//
//memory.WriteBytes(libue4header + 0xA6ADBC,new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true); //--strtok
//memory.WriteBytes(libue4header + 0xA6B974,new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true); //--strtok_r
//memory.WriteBytes(libue4header + 0x4DBE0C0,new BYTE[]{ 0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);// --j_strtok
//memory.WriteBytes(libue4header + 0x4DBE69C,new BYTE[]{ 0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);// --j_strtok_r
//
//memory.WriteBytes(libue4header + 0xEDE860,new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0xF3C13C,new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0xF3F059,new BYTE[]{0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F}, true);
//memory.WriteBytes(libue4header + 0xF3F0F0,new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0xF47B58,new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
...
//memory.WriteBytes(libue4header + 0xF4EE00,new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0xF51A00,new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0xF6A9F4,new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0xF9B240,new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0xFB3E40,new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0xFB4C78,new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0xFB5BD4,new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0xFCFFC4,new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x100AC50, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x106BE2C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x106C784, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x10FE3EC, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1174B38, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11B9140, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11B92E0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11B9C34, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11B9D40, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11B9E98, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11BA224, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11BA330, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11BA690, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11BA994, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11BAD40, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11BAF24, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11BB518, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11BB8E4, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11DA2CC, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11E07C0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11E2E34, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11ED234, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11EDA0C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11EDD4C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11EDF8C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11EEBE4, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11EF034, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11EF9AC, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11F0070, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11F0F3C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11F1688, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11F6CF0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11F6F00, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11F7790, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11F8960, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11F8EA0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11F9040, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11F91C8, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11F9388, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11F93AC, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11F9584, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11F9C24, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11FA0E0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11FA614, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11FA81C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11FAC08, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11FACCC, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11FAD7C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x11FB210, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x120188E, new BYTE[]{0xE0}, true);
//memory.WriteBytes(libue4header + 0x1201890, new BYTE[]{0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x12018A0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1201A8C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1201B20, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1201C90, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1201CD4, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1201E24, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x120279C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x12028BC, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1203058, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1203138, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1203B30, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1203CC0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1204130, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x120D830, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1228DB0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1278FA4, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x127907C, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x127D400, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x12FBE9C, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x12FD784, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x13303B4, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1341BB8, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1349A28, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x134ABB4, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x134B28C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1412344, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x14DBA64, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x14DBD3C, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x14DE900, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x14DE9F0, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x14DEAC8, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x153363C, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x153462C, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x153483C, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x15349B8, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1534DB0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1534F4C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1535340, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x15356E8, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1535B90, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1536AFC, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1536ED8, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x15372C8, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1537A04, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x153A2A8, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x153A900, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x153AC64, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x153B2D8, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x153BC34, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x153BDD0, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x153BF48, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x153CD14, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x153D4BC, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x153D5E0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x153DF34, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x153EED4, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x153F2B4, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x153F558, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x153F7D0, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x153FA20, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x153FBF8, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x153FD04, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x15417A4, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1541C80, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1542C0C, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x155E41C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x155F314, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x155F5B8, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x155FB54, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x155FCF4, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1560460, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x156067C, new BYTE[]{0x00, 0x00, 0x00, 0x00}, true);
//memory.WriteBytes(libue4header + 0x1561ABC, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x15620D8, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x15621F4, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1562658, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x15631D0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x156339C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x15643A8, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x156459C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1564AAC, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1565050, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x156532C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x15656C4, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1565BBC, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1565E98, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1566138, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x15662C0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1580AF8, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1580DF0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x15B2428, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x15B2DC8, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x15BAEAC, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x161AB7C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x161B3D8, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x16222E0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1625050, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x16258F4, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x16259C4, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1625D4C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x162E07C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x162F380, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x16308B0, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1630CF4, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1642488, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x164753C, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
...
//memory.WriteBytes(libue4header + 0x1647F7C, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1648B38, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x164BF30, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x164C30C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x164CF24, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x165A63C, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x16686B8, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x166DE80, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1676E3C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x16B530C, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x16B7520, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x16BB29C, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x16C2630, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x16C7500, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x16C78FC, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x16C7F84, new BYTE[]{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x16C8528, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x16C89D4, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x16D1488, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x16D22B8, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x16EAAF0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x16F7B90, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x16F9B38, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x16F9B50, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x16F9D88, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x16F9DFC, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x16FAFE4, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x16FE810, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1703FA8, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x170E564, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1723750, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1723D51, new BYTE[]{0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F}, true);
//memory.WriteBytes(libue4header + 0x1728F04, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x174A4C8, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x174A93C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x174ADD8, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x174B45C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x174B768, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x174BA48, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x174BFB8, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1809D1C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x18375F4, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x18384A0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x18394AC, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1839FF4, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x183A164, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x183A1C0, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1843664, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x184390C, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1848E1C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1848FC0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x184A8D4, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x184B600, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x18D7434, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x18F1EA8, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x195C1E4, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x19B4E70, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x19B95D4, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x19B97C8, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x19B9B84, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x19DA5F8, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x19DC010, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x19DFB10, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x19E9CC0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x19ED1D0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x19F3190, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A07DD0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A08340, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A09548, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A09B70, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A0B0C0, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
...
//memory.WriteBytes(libue4header + 0x1A1400A, new BYTE[]{0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A148D1, new BYTE[]{0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F}, true);
//memory.WriteBytes(libue4header + 0x1A14B1C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A15A20, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A17E68, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A1829C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A18870, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A19054, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A191B8, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A19828, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A1989C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A19A78, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A19AC0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A1A09C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A1A170, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A1A768, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A1A840, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A1A960, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A1B028, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A1B268, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A1B43C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A1B5E4, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A1B69C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A1B754, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A203C8, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A204EC, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A20664, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A20EF8, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A21174, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A213A4, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A215E4, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A218C0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A219E4, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A21A70, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A21ADC, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A21C78, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A21CE0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A21DE8, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A21FDC, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A22511, new BYTE[]{0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F}, true);
//memory.WriteBytes(libue4header + 0x1A22544, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A22790, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A22A24, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A22B60, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A22CA0, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A22DF0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A230E8, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A2334C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A23670, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A23770, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A237C8, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A2387C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A23B14, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A23C1C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A23D10, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A24438, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A24460, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A246FC, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A247E8, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A24A10, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A255AC, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A256C8, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A25774, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A25A34, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A25D74, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A25E84, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A2E5C8, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A2F1CC, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A2F678, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A2FE68, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A2FE9C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A2FF80, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A30448, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A30800, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A30A78, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A31020, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A310DC, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A311CC, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A31375, new BYTE[]{0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F}, true);
//memory.WriteBytes(libue4header + 0x1A314D8, new BYTE[]{0x00}, true);
//memory.WriteBytes(libue4header + 0x1A314DA, new BYTE[]{0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A3159C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A316A4, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A31BA4, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A31CEC, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A31E08, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A31FE4, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A32080, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A32300, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A32FD4, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A33528, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A339BC, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A33B44, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A33D2C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A33EE0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A3426C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A34445, new BYTE[]{0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F}, true);
//memory.WriteBytes(libue4header + 0x1A3449C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A34718, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A34B4C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A34CC4, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A34E3C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A34FE0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A352A0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A35588, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A35BA8, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A35C40, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A368E8, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A36990, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A369F4, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A36A74, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A36B2C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A36E48, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A373E8, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A37AF0, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A37CF4, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A3B4C8, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A3D108, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A3D24D, new BYTE[]{0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F}, true);
//memory.WriteBytes(libue4header + 0x1A3D304, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1A3D401, new BYTE[]{0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F}, true);
...
//memory.WriteBytes(libue4header + 0x1AFCA38, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1AFCEC0, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1AFCFEC, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1AFDDD8, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1AFE144, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1B002D0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1B008A8, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1B00BDC, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1B01034, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1B013D4, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1B01934, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1B01CC4, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1B01DAC, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1B0204C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1B020D1, new BYTE[]{0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F}, true);
//memory.WriteBytes(libue4header + 0x1B02124, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1B023E0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1B024AC, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1B02848, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1B02D5C, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1B03070, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1B03480, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1B03B34, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1B03F3C, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1B0474C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1B0592C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1B05FF8, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1B06D78, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1B071B4, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1B081E0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1B08728, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1B088F0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1B19670, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1C1ED58, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1D62738, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1D62B0C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1D62BC8, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1D63320, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1D635DC, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1D640B0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1D64B1C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1D65AC8, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1D65BB8, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1D99C80, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1DE0690, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1DE0900, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1DE0F8C, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1DE16DC, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1DF5A50, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1E41FF0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1E447A1, new BYTE[]{0x00}, true);
//memory.WriteBytes(libue4header + 0x1E447A4, new BYTE[]{0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1E4CB18, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1E4D3B0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1E4DA00, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1F0A1A8, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1F0A454, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1F0A9A8, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1F0AA54, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1F0AE7C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1F0B488, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1F0B9AC, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x1F0CE8C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x208F7EC, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x20B6858, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x20F7988, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x213A57C, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x2178D6C, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x2179BD4, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x2179D00, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x2179DB0, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x22BC17C, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x255A0F4, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x25E4AE0, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x261D0F2, new BYTE[]{0xA0}, true);
//memory.WriteBytes(libue4header + 0x261D0F4, new BYTE[]{0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x261D3EC, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x26373C0, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x2661D44, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x26639C4, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x2663A3C, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x2663B4C, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x2678A20, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x269CCD4, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x26D9244, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x26D9394, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x26D9500, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x26D973C, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
...
//memory.WriteBytes(libue4header + 0x26D98F4, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x26DB470, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x26DCD90, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x26DD174, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x26EA834, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x26EB250, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x26EB668, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x26EB858, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x26F6388, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x2708E04, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x2709608, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x2709D80, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x270A7C0, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x276A1F8, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x277F75C, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x27902C8, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x28131B4, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x2813384, new BYTE[]{0x64, 0x09, 0xA0, 0x00, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x2895F28, new BYTE[]{0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x2898758, new BYTE[]{0x00}, true);
//memory.WriteBytes(libue4header + 0x289875B, new BYTE[]{0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x28CBA04, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
...
//memory.WriteBytes(libue4header + 0x28CD13C, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x28D504C, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x295129C, new BYTE[]{0x00}, true);
//memory.WriteBytes(libue4header + 0x295129E, new BYTE[]{0xE0}, true);
//memory.WriteBytes(libue4header + 0x2F5B034, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x30D1C30, new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x3741BF0, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x3A8AD1C, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x3A8B568, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x3A8B6B8, new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
...
//memory.WriteBytes(libue4header + 0x3A8CF20,new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x3A8D924,new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x3B0DC58,new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x3C147C8,new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x3C14C88,new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x3C14F80,new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x3D19C80,new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
...
//memory.WriteBytes(libue4header + 0x3E463C4,new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x3E46AA0,new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x3E76EF8,new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x3E90D0C,new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x3E90F20,new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x3E91730,new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x3E9197C,new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x3E921B4,new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x3E92930,new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x3E92D80,new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x3E9310C,new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x3E934AC,new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x3E93CA4,new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x45F1218,new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x48AB838,new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x48ABBAC,new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x48ABCA8,new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x48AC244,new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x48AC838,new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x48ACBAC,new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x4CEE4FC,new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x4CEEC74,new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x4FD540C,new BYTE[]{0x00, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x508EA90,new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x509238C,new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
//memory.WriteBytes(libue4header + 0x5092D24,new BYTE[]{0x00, 0x00, 0xE0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
...
//	memory.WriteBytes(libue4header + 0x452D3F0, new BYTE[]{ 0x00,0x00,0x90 }, true);
//	memory.WriteBytes(libue4header + 0x452D3F4, new BYTE[]{ 0x48,0x00,0x0B,0xE5 }, true);
	memory.WriteBytes(libue4header + 0x1C0D784, new BYTE[]{ 0x05, 0x00, 0xA0, 0xE3, 0x1E, 0xFF, 0x2F, 0xE1}, true);
	//Sleep(3000);

	resume(pid);
//
//CString str12;
//str12.Format(_T("%d"), libtersafeheader);
//string s1 = to_string(libtersafeheader);
//MessageBoxA(0, "fuck libtersafeheader ", s1.c_str(), 0);
//
//memory.WriteBytes(Tprt + 0x1E3DC, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(Tprt + 0x5DB8, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(Tprt + 0x5E60, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(Tprt + 0x498C, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(Tprt + 0x59490, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(Tprt + 0x52290, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(Tprt + 0x33300, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(Tprt + 0x31A5C, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(Tprt + 0x1FF62, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(Tprt + 0xA3CC, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(Tprt + 0x1C25C, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(Tprt + 0x20BDE, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//
//
//memory.WriteBytes(GCloud + 0x183BB0, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(GCloud + 0x1846B0, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(GCloud + 0x1045F0, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(GCloud + 0x105B88, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(GCloud + 0x104AD4, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(GCloud + 0x10563C, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(GCloud + 0x1060E8, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(GCloud + 0x105B88, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(GCloud + 0x105E04, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(GCloud + 0x105E58, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(GCloud + 0x105F0C, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(GCloud + 0x106310, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(GCloud + 0x106588, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(GCloud + 0x106608, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(GCloud + 0x1069A8, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(GCloud + 0x107008, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(GCloud + 0x107410, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(GCloud + 0x107BD8, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(GCloud + 0x107DE0, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(GCloud + 0x107F9C, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(GCloud + 0x1085D4, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(GCloud + 0x108BCC, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(GCloud + 0x109514, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(GCloud + 0x109AC4, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(GCloud + 0x10A2F0, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(GCloud + 0x10ADF0, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(GCloud + 0x10B3A8, new BYTE[]{ 0x00, 0x20, 0x4F, 0xF0, 0x00, 0x00, 0x70, 0x47 }, true);
//memory.WriteBytes(GCloud + 0x3E7EC, new BYTE[]{ 0x00, 0x00, 0xa0, 0xe3, 0x1e, 0xff, 0x2f, 0xe1 }, true);
//memory.WriteBytes(GCloud + 0x3E7F8, new BYTE[]{ 0x00, 0x00, 0xa0, 0xe3, 0x1e, 0xff, 0x2f, 0xe1 }, true);
